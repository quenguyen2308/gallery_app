...
private val artStyles = listOf(
    ...
    ArtStyle("Sơn dầu", "classical oil painting, visible brush strokes, rich texture"),
    ArtStyle("Ký họa", "black and white pencil sketch, hand-drawn cross-hatching"),
    ArtStyle("Màu nước", "soft watercolor painting, gentle color bleeding, paper texture"),
